...
public class KafkaConfig {
    @Bean
    public ConsumerFactory<String, String> consumerFactory(@Value("${spring.kafka.bootstrap-servers[0]}") final String bootstrapServers){
    ...
    @Bean
    public ProducerFactory<String, String> producerFactory(@Value("${spring.kafka.bootstrap-servers[0]}")final String bootstrapServers){
        final Map<String, Object> config = new HashMap<>();
